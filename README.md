...
> [!IMPORTANT]
> This project is a native Rust port and fork of
> [eduwass/tmux-palette](https://github.com/eduwass/tmux-palette).
>
> Existing `~/.config/tmux-palette` JSON configuration is intended to work
